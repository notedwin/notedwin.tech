...
summary: "Building upon the attack map: SSH article, this post will cover how to get process and use NGINX logs."
tags: "attack-map, featured"
---
...
<Image src="/assets/attack-map/no.gif" alt="bruh" width={640} height={500} />
...
<Image src="/assets/attack-map/map.png" alt="map" width={640} height={500} />
